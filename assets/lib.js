...
var Vimeo = {
    ...
    attach: function () {
        var self = this,
            ...
            structure = [
            '<div class="featured">',
                '<iframe src="http://player.vimeo.com/video/'+main+'?api=1" width="960" height="540" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen id="current-video" />',
            '</div>',
